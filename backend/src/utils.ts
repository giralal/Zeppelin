...
export function successMessage(str: string, emoji = "<:green_check:1158062469181358223>") {
  return emoji ? `${emoji} ${str}` : str;
}

export function errorMessage(str: string, emoji = "<:red_x:1158062398842875934>") {
  return emoji ? `${emoji} ${str}` : str;
}
